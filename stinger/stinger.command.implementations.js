...
.config(['commandBrokerProvider', function (commandBrokerProvider) {
    ...
    var stingerCameraCommandHandler = function () {
        ...
        me.description = [
            "Shuts down cameras in an infected facility."
        ];
        ...
        var passid = null;
        var success_code = "AJ" + 5*43 + "KM";      // AJ215KM
            ...
            switch(param1) {
                ...
                case selected_cam:
                    ...
                    if (flag === true) {
                        ...
                        session.output.push({ output: true, text: [
                            "The guard caught you! You're locked out!"
                        ], breakLine: true });
                    } else if(param2 === password_list[passid] && passid !== null) {    // The user guessed right
                        session.output.push({ output: true, text: [
                        ...
                        session.output.push({ output: true, text: [
                            "You did not start an ANTENNA session!"
                        ], breakLine: true });
                    } else {
                        session.output.push({ output: true, text: [
                ...
                case "select":
                    ...
                    if ((Object.keys(cam_list).indexOf(param2) > -1) === false) {
                        session.output.push({ output: true, text: [
                    ...
                    session.output.push({ output: true, text: [
                        ...
                        "You have 1 minute remaining to enter the correct password."
                    ], breakLine: true });
                    console.log(password_list[passid]);
                    passTimer();
