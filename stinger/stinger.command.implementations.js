...
.config(['commandBrokerProvider', function (commandBrokerProvider) {
    ...
    var stingerCameraCommandHandler = function () {
        ...
        me.description = [
            ...
            "Example: stinger-cm list-cams",
            "Example: stinger-cm start cam1",
            "Example: stinger-cm password1234"
        ];

        var cam_list = {"cam_1": 0, "cam_2": 0, "cam_3": 0};
            ...
            switch(param1) {
                ...
                case "pass":
                    if (flag === true) {
                        ...
                        console.log(flag);
                    } else if(param2 === password_list[passid] && passid !== null) {
                        console.log(param2);
                        session.output.push({ output: true, text: [
